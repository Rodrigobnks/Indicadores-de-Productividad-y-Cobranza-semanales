...
st.markdown(
    ...
    /* Labels: Vista, Moneda, Marca, País, Indicador, etc. */
    label,
    ...
    /* Evita que modo oscuro/extensiones cambien inputs */
    input,
    textarea,
    select {
        color: #061a40 !important;
    ...
    /* Evita traducción automática visual sobre bloques del tablero */
    .stApp {
        translate: no;
    }
    </style>
