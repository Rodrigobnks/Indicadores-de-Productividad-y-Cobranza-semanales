...
# ============================================================
# AJUSTE FINAL: FORZAR MODO BLANCO CON IMAGEN COMO MARCA DE AGUA
# No modifica la lógica del tablero.
# Este bloque queda al final para pisar cualquier regla de modo oscuro
# que venga del navegador, Windows, Streamlit o CSS anterior.
# ============================================================
st.markdown(
    """
    <style>
...
# ============================================================
# AJUSTE DEFINITIVO: MODO BLANCO FORZADO + FONDO COMO MARCA DE AGUA
# Este bloque queda al final para que gane sobre cualquier regla anterior,
# incluyendo modo oscuro del navegador/Windows y estilos de Streamlit.
# ============================================================
st.markdown(
    """
    <style>
    ...
    /* La app queda blanca; la imagen se manda a una capa fija detrás como marca de agua. */
    .stApp {
    ...
    /* Pantalla inicial: forzar fondo claro donde se escoge la marca. */
    .landing-wrap {
